import {
  Texture, Resource, ILoaderResource, BaseTexture
} from 'pixi.js';
...
//        cardFrames.push({
//          name: `card-${1}-${1}`,
//          frame: [CARD_WIDTH * 1, CARD_HEIGHT * 1, CARD_WIDTH, CARD_HEIGHT],
//        });
     

export function getSmily():Texture {
  const baseTexture = new BaseTexture(resources.coin11.url);
